import { ListResult as StorageListResult, StorageReference } from 'firebase/storage'
...
export const toStorageItem = (ref: StorageReference, type: 'file' | 'folder'): StorageNode => {
    return {
        type,
        name: ref.name,
        path: ref.fullPath
